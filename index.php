...
if(isset($_POST)&&!empty($_POST)){
    ...
    $mail->Username = 'khush22786@gmail.com'; //Sets SMTP username
    $mail->Password = "Khu5h@Manu"; //Sets SMTP password
    $mail->SMTPSecure = 'ssl'; //Sets connection prefix. Options are "", "ssl" or "tls"
    $mail->From = $_POST['email']; //Sets the From email address for the message
    $mail->FromName = $_POST['fullname']; //Sets the From name of the message
    $mail->AddAddress('khush22786@gmail.com', 'Hello Khushpinder'); //Adds a "To" address
...
<head>
    ...
    <title>Khushpinder - Developer Portfolio</title>
    ...
    <section id="about" class="about-section">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img class="img-responsive" src="images/bg/me.jpeg" draggable="false" alt="">
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="section-title">
                        <h2>My Portfolio.</h2>
                        <p>List of Professional Projects</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <ul class="portfolio">
                    ...
                    <li class="filter" data-filter=".node">node</li>
                </ul>
            </div>
            ...
            <div class="portfolio-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix php">
                        <div class="item">
                            <a href="https://www.trytokr.com/" class="" target="_blank" title="Tokr">
                                <img src="images/portfolio/1.jpg" alt="">
                            </a>
                        </div>
                    </div>

                    <div class="col-md-4 col-sm-6 col-xs-12 mix ror">
                        <div class="item">
                            <a href="https://www.edhero.com/" class="" target="_blank" title="EdHero">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix php">
                        <div class="item">
                            <a href="http://evrylife.com/" class="" target="_blank" title="Evrylife">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix ror">
                        <div class="item">
                            <a href="https://fittogether.com/" class="" target="_blank" title="FitTogether">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix node" title="International Fair Timeshare Agency">
                        <div class="item">
                            <a href="http://ifta.zapbuild.com/" class="" target="_blank">
                ...
                <div class="statistics-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistics">
                            ...
                            <div class="statistics-content">
                                <h3><span data-count="6" class="statistics-count">6</span></h3><span>Projects
                                    Done</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistics">
                            ...
                            <div class="statistics-content">
                                <h3> <span data-count="6" class="statistics-count">6</span></h3><span>Happy
                                    Clients</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistics">
                            ...
                            <div class="statistics-content">
                                <h3><span data-count="1800" class="statistics-count">1800</span></h3><span>Hours of
                                    Work</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="statistics">
                            ...
                            <div class="statistics-content">
                                <h3><span data-count="2000" class="statistics-count">2000</span></h3><span>Cup of
                                    Coffee</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="services-detail">
                        ...
                        <h3>Design</h3>
                        <hr>
                        <p>I have good knowledge of the design of websites using HTML5, CSS3, and Bootstrap.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="services-detail">
                        <i class="fa fa-diamond color-5"></i>
                        <h3>Ruby on Rails</h3>
                        <hr>
                        <p>I finished projects related to LMS and Fitness in Ruby on Rails.</p>
                    </div>
                </div>
    ...
    <section id="contact" class="contact-us section-space-padding">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="contact-us-detail">
                            ...
                            <p><a href="tel:+14389292243">(438) 929 2243</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="contact-us-detail">
                            ...
                            <p><a href="mailto:khush22786@gmail.com">khush22786@gmail.com</a></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <form action="index.php" method="post">
                            ...
                            <div class="col-sm-12">
                                <div class="textarea-message form-group">
                                    <textarea id="message" class="textarea-message form-control"
                                        placeholder="Your Message" rows="5" name="message"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="button button-style button-style-dark button-style-icon fa fa-long-arrow-right text-center">Submit</button>
                            </div>
        ...
        <div class="margin-top-80">
            <ul class="social-icon">
                <li><a href="https://www.facebook.com/khush.velha" target="_blank" class="facebook"><i
                            class="fa fa-facebook"></i></a></li>
                <li><a href="https://twitter.com/khush_786" target="_blank" class="twitter"><i
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-left">
                    <p><span><a href="#about" class="smoth-scroll">About Me</a></span> | <span><a href="#portfolio"
                                class="smoth-scroll">Portfolio</a></span></p>
                </div>
